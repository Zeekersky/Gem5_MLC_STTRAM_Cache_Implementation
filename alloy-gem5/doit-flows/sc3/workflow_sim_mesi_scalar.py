#============================================================================
# workflow_sim_mesi_scalar
#============================================================================
# Simulate baseline MESI (scalar using 1 thread in 64-core system)
#
# Date    : 19/08/10
# Author  : Tuan Ta
...
def task_sim_mesi_scalar():
  ...
  for suite_json in suite_json_list:
    ...
    sims, sim_names = generate_sim_task( sim_name         = "mesi-scalar",
  ...
  yield { "basename" : "sim-mesi-scalar",
          "actions"  : None,
