...
def task_sim_big_tiny_denovo_am():

  # gem5 sim parameter file

  gem5_config_file = curdir + "/gem5-configs/configs-big-tiny-am.json"
  ...
  for suite_json in suite_json_list:
    ...
    sims, sim_names = generate_sim_task( sim_name         = "big-tiny-denovo-am",
  ...
  yield { "basename" : "sim-big-tiny-denovo-am",
          "actions"  : None,
