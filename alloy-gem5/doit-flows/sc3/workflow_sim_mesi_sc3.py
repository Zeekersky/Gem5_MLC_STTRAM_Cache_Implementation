#============================================================================
# workflow_sim_mesi_sc3
#============================================================================
# Simulate SC3 app on baseline MESI
#
# Date    : 19/08/10
# Author  : Tuan Ta
...
def task_sim_mesi_sc3():
  ...
  for suite_json in suite_json_list:
    ...
    sims, sim_names = generate_sim_task( sim_name         = "mesi-sc3",
