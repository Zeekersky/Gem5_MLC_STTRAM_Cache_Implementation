...
{
   'ubmark-vvadd'    : {
                         'tiny'    : [ '--impl omp_static --warmup --size   256 --verify' ],
                         'small'   : [ '--impl omp_static --warmup --size  1024 --verify' ],
                         'medium2' : [ '--impl omp_static --warmup --size  8192 --verify' ],
                         'medium4' : [ '--impl omp_static --warmup --size 16384 --verify' ],
                         'medium8' : [ '--impl omp_static --warmup --size 32768 --verify' ],
                       },
}
...
#     Set app_list and app_dict
#----------------------------------------------------------------------------

#app_list =
#app_dict =

app_list = ubmark_app_list
app_dict = ubmark_app_dict

#app_list = ligra_app_list_omp
